using bbs.D3S.Domain.SeedWork.NSpecifications;
...
namespace bbs.D3S.Domain.SeedWork
{
        ...
        where TDbContext : DbContext, IUnitOfWork
    {
        ...
        public TEntity Get(TPrimaryKey id) => _context.Set<TEntity>().Find(id);
        public async Task<TEntity> GetAsync(TPrimaryKey id) => await _context.Set<TEntity>().FindAsync(id);
